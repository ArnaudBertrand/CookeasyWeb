...
/**
 * @ngdoc function
 * @name applicationApp.controller:CreateRecipeCtrl
 * @description
 * # CreateRecipeCtrl
 * Controller of the applicationApp
 */
angular.module('applicationApp')
  .controller('CreateRecipeCtrl', ['$scope', '$state', 'Upload', 'RecipeService',
    function ($scope, $state, Upload, RecipeService) {
...
//          return false;
      ...
      $scope.createRecipe = function(){
        ...
        RecipeService.create($scope.recipe).then(function(id){
