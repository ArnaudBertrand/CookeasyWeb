(function(){
  ...
  angular.module( 'app.recipe.display',[])
  ...
  function RecipeDisplayCtrl($http,$stateParams,$timeout,recipePre,ceRecipesComments,ceModalGallery){
    ...
    vm.picturesUploadUrl = 'https://mysterious-eyrie-9135.herokuapp.com/recipes/'+$stateParams.id+'/pictures';
    ...
    function timerTick (){
      ...
      if(vm.timerSecondsPassed == vm.currentStep.time*60) {return vm.timerStop();}
      timer = $timeout(timerTick,1000);
    }
  }
})();
